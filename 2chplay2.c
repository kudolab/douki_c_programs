...
// clang 2chplay2.c -o 2chplay /Users/audio/portaudio/lib/.libs/libportaudio.a -framework CoreAudio -framework AudioToolbox -framework AudioUnit -framework CoreServices
...
int main(int argc,char *argv[])
{
    ...
    fprintf(stdout,"Reading audio data file:%s.\n",filename);
    ...
    /* -- setup -- */
    fprintf(stdout,"Open the portaudio stream\n"); fflush(stdout);
    err = Pa_OpenStream(
              &stream,
              NULL,
              &outputParameters,
    ...
    fprintf(stdout,"Start the portaudio stream\n"); fflush(stdout);
