...
bin/FC_deviation: FC_deviation.c Filelib_osx.c
	gcc FC_deviation.c Filelib_osx.c -O2 -Wall -W -o bin/FC_deviation -I/usr/local/include -lm

bin/FC_deviation_alter: FC_deviation_alter.c Filelib_osx.c
	gcc FC_deviation_alter.c Filelib_osx.c -O2 -Wall -W -o bin/FC_deviation_alter -I/usr/local/include -lm

bin/IMPmcode: IMPmcode.c Filelib_osx.c
	gcc IMPmcode.c Filelib_osx.c -O2 -Wall -W -o bin/IMPmcode -I/usr/local/include -lm

bin/LE_1: LE_1.c Filelib_osx.c
	gcc LE_1.c Filelib_osx.c -O2 -Wall -W -o bin/LE_1 -I/usr/local/include -lm

bin/WAVtoDSB_osx: WAVtoDSB_osx.c Filelib_osx.c
	gcc WAVtoDSB_osx.c Filelib_osx.c -O2 -Wall -W -o bin/WAVtoDSB_osx -I/usr/local/include -lm

bin/biascut: biascut.c Filelib_osx.c
	gcc biascut.c Filelib_osx.c -O2 -Wall -W -o bin/biascut -I/usr/local/include -lm

bin/calc_ILD: calc_ILD.c Filelib_osx.c
	gcc calc_ILD.c Filelib_osx.c -O2 -Wall -W -o bin/calc_ILD -I/usr/local/include -lm

bin/cosine_windowing: cosine_windowing.c Filelib_osx.c
	gcc cosine_windowing.c Filelib_osx.c -O2 -Wall -W -o bin/cosine_windowing -I/usr/local/include -lm

bin/cutout_anyfile: cutout_anyfile.c Filelib_osx.c
	gcc cutout_anyfile.c Filelib_osx.c -O2 -Wall -W -o bin/cutout_anyfile -I/usr/local/include -lm

bin/cutout_anyfile2: cutout_anyfile2.c Filelib_osx.c
	gcc cutout_anyfile2.c Filelib_osx.c -O2 -Wall -W -o bin/cutout_anyfile2 -I/usr/local/include -lm

bin/douki_new: douki_new.c Filelib_osx.c
	gcc douki_new.c Filelib_osx.c -O2 -Wall -W -o bin/douki_new -I/usr/local/include -lm

bin/dv: dv.c Filelib_osx.c
	gcc dv.c Filelib_osx.c -O2 -Wall -W -o bin/dv -I/usr/local/include -lm

bin/equ_schroeder1: equ_schroeder1.c Filelib_osx.c
	gcc equ_schroeder1.c Filelib_osx.c -O2 -Wall -W -o bin/equ_schroeder1 -I/usr/local/include -lm

bin/equ_schroeder2: equ_schroeder2.c Filelib_osx.c
	gcc equ_schroeder2.c Filelib_osx.c -O2 -Wall -W -o bin/equ_schroeder2 -I/usr/local/include -lm

bin/equ_schroeder3: equ_schroeder3.c Filelib_osx.c
	gcc equ_schroeder3.c Filelib_osx.c -O2 -Wall -W -o bin/equ_schroeder3 -I/usr/local/include -lm

bin/equ_schroeder4: equ_schroeder4.c Filelib_osx.c
	gcc equ_schroeder4.c Filelib_osx.c -O2 -Wall -W -o bin/equ_schroeder4 -I/usr/local/include -lm

bin/equ_schroeder5: equ_schroeder5.c Filelib_osx.c
	gcc equ_schroeder5.c Filelib_osx.c -O2 -Wall -W -o bin/equ_schroeder5 -I/usr/local/include -lm

bin/fatchdb: fatchdb.c Filelib_osx.c
	gcc fatchdb.c Filelib_osx.c -O2 -Wall -W -o bin/fatchdb -I/usr/local/include -lm

# bin/fft: fft.c Filelib_osx.c
# 	gcc fft.c Filelib_osx.c -O2 -Wall -W -o bin/fft -I/usr/local/include -lm

bin/find_cutpoint: find_cutpoint.c Filelib_osx.c
	gcc find_cutpoint.c Filelib_osx.c -O2 -Wall -W -o bin/find_cutpoint -I/usr/local/include -lm

bin/henkan: henkan.c Filelib_osx.c
	gcc henkan.c Filelib_osx.c -O2 -Wall -W -o bin/henkan -I/usr/local/include -lm

# bin/ifft: ifft.c Filelib_osx.c
# 	gcc ifft.c Filelib_osx.c -O2 -Wall -W -o bin/ifft -I/usr/local/include -lm

bin/imp_add: imp_add.c Filelib_osx.c
	gcc imp_add.c Filelib_osx.c -O2 -Wall -W -o bin/imp_add -I/usr/local/include -lm

bin/imp_add_by10: imp_add_by10.c Filelib_osx.c
	gcc imp_add_by10.c Filelib_osx.c -O2 -Wall -W -o bin/imp_add_by10 -I/usr/local/include -lm

bin/inverse: inverse.c Filelib_osx.c
	gcc inverse.c Filelib_osx.c -O2 -Wall -W -o bin/inverse -I/usr/local/include -lm

bin/mono2LR: mono2LR.c Filelib_osx.c
	gcc mono2LR.c Filelib_osx.c -O2 -Wall -W -o bin/mono2LR -I/usr/local/include -lm

bin/overlap_add: overlap_add.c Filelib_osx.c
	gcc overlap_add.c Filelib_osx.c -O2 -Wall -W -o bin/overlap_add -I/usr/local/include -lm

bin/peaking_filter: peaking_filter.c Filelib_osx.c
	gcc peaking_filter.c Filelib_osx.c -O2 -Wall -W -o bin/peaking_filter -I/usr/local/include -lm

bin/print_siglen: print_siglen.c Filelib_osx.c
	gcc print_siglen.c Filelib_osx.c -O2 -Wall -W -o bin/print_siglen -I/usr/local/include -lm

bin/random: random.c Filelib_osx.c
	gcc random.c Filelib_osx.c -O2 -Wall -W -o bin/random -I/usr/local/include -lm

bin/scaling_max_instant_amp: scaling_max_instant_amp.c Filelib_osx.c
	gcc scaling_max_instant_amp.c Filelib_osx.c -O2 -Wall -W -o bin/scaling_max_instant_amp -I/usr/local/include -lm

bin/sepach: sepach.c Filelib_osx.c
	gcc sepach.c Filelib_osx.c -O2 -Wall -W -o bin/sepach -I/usr/local/include -lm

bin/sinwave: sinwave.c Filelib_osx.c
	gcc sinwave.c Filelib_osx.c -O2 -Wall -W -o bin/sinwave -I/usr/local/include -lm

bin/timeconvo: timeconvo.c Filelib_osx.c
	gcc timeconvo.c Filelib_osx.c -O2 -Wall -W -o bin/timeconvo -I/usr/local/include -lm

bin/unbias: unbias.c Filelib_osx.c
	gcc unbias.c Filelib_osx.c -O2 -Wall -W -o bin/unbias -I/usr/local/include -lm

bin/zeropad_anyfile: zeropad_anyfile.c Filelib_osx.c
	gcc zeropad_anyfile.c Filelib_osx.c -O2 -Wall -W -o bin/zeropad_anyfile -I/usr/local/include -lm
...
bin/fftout2: fftout2.c Filelib_osx.c
	gcc fftout2.c Filelib_osx.c -O2 -Wall -W -o bin/fftout2 -I/usr/local/include -L/usr/local/lib -lfftw3 -lm

bin/fftout3: fftout3.c Filelib_osx.c
	gcc fftout3.c Filelib_osx.c -O2 -Wall -W -o bin/fftout3 -I/usr/local/include -L/usr/local/lib -lfftw3 -lm

bin/fftout4: fftout4.c Filelib_osx.c
	gcc fftout4.c Filelib_osx.c -O2 -Wall -W -o bin/fftout4 -I/usr/local/include -L/usr/local/lib -lfftw3 -lm

bin/make_whitenoise: make_whitenoise.c Filelib_osx.c
	gcc make_whitenoise.c Filelib_osx.c -O2 -Wall -W -o bin/make_whitenoise -I/usr/local/include -L/usr/local/lib -lfftw3 -lm
...
c_vector.o: umasig/c_vector.c
	gcc -c umasig/c_vector.c -O2 -Wall -W -o c_vector.o

complex.o: umasig/complex.c
	gcc -c umasig/complex.c -O2 -Wall -W -o complex.o

conv.o: umasig/conv.c
	gcc -c umasig/conv.c -O2 -Wall -W -o conv.o

fft.o: umasig/fft.o
	gcc -c umasig/fft.c -O2 -Wall -W -o fft.o

plot.o: umasig/plot.o
	gcc -c umasig/plot.c -O2 -Wall -W -o plot.o

random.o: umasig/random.o
	gcc -c umasig/random.c -O2 -Wall -W -o random.o

speech.o: umasig/speech.o
	gcc -c umasig/speech.c -O2 -Wall -W -o speech.o

utils.o: umasig/utils.o
	gcc -c umasig/utils.c -O2 -Wall -W -o utils.o

vector.o: umasig/vector.o
	gcc -c umasig/vector.c -O2 -Wall -W -o vector.o

window.o: umasig/window.o
	gcc -c umasig/window.c -O2 -Wall -W -o window.o

# programs using umasig
bin/calc_ITD: calc_ITD.c Filelib_osx.c lib/libumasig.a
	gcc calc_ITD.c Filelib_osx.c -O2 -Wall -W -o bin/calc_ITD -I/usr/local/include -I./umasig -L./lib -lm -lumasig

bin/fff: fff.c Filelib_osx.c lib/libumasig.a
	gcc fff.c Filelib_osx.c -O2 -Wall -W -o bin/fff -I/usr/local/include -I./umasig -L./lib -lm -lumasig

bin/linear_inpo_hrir_using_ATD: linear_inpo_hrir_using_ATD.c Filelib_osx.c lib/libumasig.a
	gcc linear_inpo_hrir_using_ATD.c Filelib_osx.c -O2 -Wall -W -o bin/linear_inpo_hrir_using_ATD -I/usr/local/include -I./umasig -L./lib -lm -lumasig

bin/fadein_fadeout_fourier: fadein_fadeout_fourier.c Filelib_osx.c lib/libumasig.a
	gcc fadein_fadeout_fourier.c Filelib_osx.c -O2 -Wall -W -o bin/fadein_fadeout_fourier -I/usr/local/include -I./umasig -L./lib -lm -lumasig
