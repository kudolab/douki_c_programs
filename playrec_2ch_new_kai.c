...
// clang playrec_2ch_new_kai.c -o playrec_2ch_new /usr/local/Cellar/portaudio/19.6.0/lib/libportaudio.a -framework CoreAudio -framework AudioToolbox -framework AudioUnit -framework CoreServices
...
int main(int argc,char *argv[])
{
    ...
    for(n=0;n<((NUM_REPETITION+1)*mcode_len*NUM_CHANNELS);n++) rec_raw_data[n] = (double)read_buffer_all[n];
    
    AnyFileWrite(argv[3],&rec_raw_data[DOUKI_START*NUM_CHANNELS],((NUM_REPETITION+1)*mcode_len*NUM_CHANNELS)-DOUKI_START*NUM_CHANNELS);
